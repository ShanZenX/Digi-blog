...
export default function Blog(props) {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="md:w-[30%] sm:w-full  bg-white p-3 rounded-lg hover:shadow-md">
      <Link
        href={props.to}
      ...
      >
        ...
        <div className="flex w-full">
          <div className="w-2/3 flex">
            <Image
              src={
                "https://img.freepik.com/free-vector/hand-drawn-collage-design_23-2149543516.jpg?w=1480&t=st=1704101631~exp=1704102231~hmac=c9e24da137942da4ff5a42a1aa083f817f348c78e318a081118b4365a48f45e6"
              }
              width={25}
              height={25}
